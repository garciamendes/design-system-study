...
declare const Avatar: (props: IAvatarProps) => react_jsx_runtime.JSX.Element;
...
export { Avatar, Box, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type IAvatarProps, type IBoxProps, type IHeadingProps, type ITextProps, MultiStep, type MultiStepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
